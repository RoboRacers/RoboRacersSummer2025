...
telemetry.update();
    ...
    public void start() {
        ...
        intake.clawServo.setPosition(0.5);
    }
    ...
    public void loop() {
        if (gamepad1.dpad_up){
            ...
            pipeline.setTargetColor(OptimizedPipeline.TargetColor.RED);

        } else  if (gamepad1.dpad_right){
            pipeline.setTargetColor(OptimizedPipeline.TargetColor.BLUE);
...
//                    intake.clawServo.setPosition(0.40);   add later
...
//                }
            ...
            case ROTATE:
                ...
                intake.turret.setPosition(0.91); // Rotate for transfer
...
//                clawServo.setPosition(1.0); // Open to release
        ...
        switch (score) {
            ...
            case FLIP:
                ...
                else if (timer.seconds() - waitStartTime > 1.5) {
